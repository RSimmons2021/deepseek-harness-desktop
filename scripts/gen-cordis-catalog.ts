...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  RemoteSendTeamMessageRequest: 'agent-team.md',
  RemoteSpawnTeammateRequest: 'agent-team.md',
  ...
  TeamActivityEntry: 'agent-team.md',
  TeamFollowFrame: 'agent-team.md',
  TeamId: 'agent-team.md',
  TeamInterruptMutationResult: 'agent-team.md',
  TeamMemberView: 'agent-team.md',
  TeamMembership: 'agent-team.md',
  TeamMessageMutationResult: 'agent-team.md',
  TeamSpawnMutationResult: 'agent-team.md',
  TeamTailLine: 'agent-team.md',
  ...
  AuthorizationStateView: 'credentials.md',
