...
- `@deepseek-ai/dsh-experimental-agent-team-write-lease` —— 需要 `agents` · `agentTeams` · `fs`（[`packages/experimental/agent-team-write-lease/src/index.ts`](../packages/experimental/agent-team-write-lease/src/index.ts)）
