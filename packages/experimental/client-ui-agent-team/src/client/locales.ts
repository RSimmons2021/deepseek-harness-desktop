...
export const zh = {
  ...
  workspaceTitle: 'Agent Team // Workspace',
  workspaceSubtitle: 'Lead agent 与 teammates 的实时共享工作空间',
  activeSession: '活跃会话',
  leadRole: 'Lead agent',
  teammateRole: '协作者',
  assignedTasks: '已分配任务',
...
export const en = {
  ...
  workspaceTitle: 'Agent Team // Workspace',
  workspaceSubtitle: 'A live, shared workspace for the lead agent and teammates',
