 ...
 *
 * Typed from the context that declares the namespace: credentials, llm, and
 * settings reach the page as operations callbacks, and the sign-in card is the
 * one consumer that still drives a namespace itself.
 */
export type ModelsAuthorization = Pick<
  ClientContext['remote']['authorization'],
