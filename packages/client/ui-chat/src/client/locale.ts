...
export const zh = {
  ...
  'settings.reasoning.title': '模型思考过程',
  'settings.reasoning.description': '控制对话中展示多少模型的思考内容',
  'settings.reasoning.collapsed': '仅摘要',
  'settings.reasoning.streaming': '思考时展开',
  'settings.reasoning.expanded': '始终展开',
...
export const en = {
  ...
  'settings.transcript.normal': 'Normal',
  'settings.transcript.compact': 'Compact',
  'settings.reasoning.title': 'Model reasoning',
  'settings.reasoning.description': 'How much of the model’s thinking the transcript shows',
  'settings.reasoning.collapsed': 'Summary only',
  'settings.reasoning.streaming': 'While it thinks',
  'settings.reasoning.expanded': 'Always open',
