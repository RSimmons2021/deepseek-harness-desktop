...
const BUILTIN_INSPECT_TOKENS: readonly ThemeTokenInspection[] = Object.freeze([
  ...
  { name: '--dsw-alias-desktop-chat-scrim', description: 'Desktop reading-column scrim over the Team ambient.', valueType: 'CSS color', requiresLightAndDark: true, cssVariable: '--dsw-alias-desktop-chat-scrim' },
  { name: '--dsw-alias-team-ground', description: 'Agent Team workspace ground.', valueType: 'CSS color', requiresLightAndDark: true, cssVariable: '--dsw-alias-team-ground' },
  { name: '--dsw-alias-team-ink', description: 'Agent Team primary ink.', valueType: 'CSS color', requiresLightAndDark: true, cssVariable: '--dsw-alias-team-ink' },
  { name: '--dsw-alias-team-surface', description: 'Agent Team translucent card surface.', valueType: 'CSS color', requiresLightAndDark: true, cssVariable: '--dsw-alias-team-surface' },
