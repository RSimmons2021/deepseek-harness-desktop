...
export const zh = {
  ...
  'suggestion.label': '建议提示',
  'suggestion.explain': '解释这个代码库的结构',
  'suggestion.findBug': '找出并修复一个 bug',
  'suggestion.tests': '为最近的改动补测试',
  'suggestion.review': '审阅未提交的改动',
...
export const en = {
  ...
  'suggestion.explain': 'Explain how this codebase is structured',
  'suggestion.findBug': 'Find and fix a bug',
  'suggestion.tests': 'Add tests for the recent changes',
  'suggestion.review': 'Review my uncommitted changes',
  'scrollToLatest': 'Back to the latest message',
