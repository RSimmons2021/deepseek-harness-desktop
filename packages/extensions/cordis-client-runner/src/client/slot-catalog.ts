...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  },
  {
    ...
    kind: 'single',
    scope: 'root',
    summary: 'Whole-window content rendered instead of browser chrome in Electron.',
    doc: 'Whole-window content rendered instead of browser chrome in Electron.',
    registerOptions: [],
    ownerProps: [],
    ownerPropsReferences: [],
    standardProps: [
    ...
    declaredBy: 'the runtime itself (built in; always present)',
    occupants: [
      'experimental-client-ui-agent-team DesktopTeamRoot',
    ],
    replaceRisk: 'shadows-shipped-ui',
